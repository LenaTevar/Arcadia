package main.java.pi.arcadia.common.baubles;
...
public class HeadBaubles extends Item implements IBauble, IHasModel{

	public HeadBaubles(String name) {
		super();
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage()==0 && player.ticksExisted%39==0) {
			player.addPotionEffect(new PotionEffect(MobEffects.GLOWING,40,0,true,false));
		}
	}
